...
nonterminals = ['<stmt>', '<return_stmt>', '<type>', '<add_tail>', '<if_stmt>', '<mul_tail>', '<expr>', '<if_tail>', '<while_stmt>', '<return_tail>', '<add_expr>', '<assign_stmt>', '<program>', '<param_list>', '<function>', '<mul_expr>', '<block_stmt>', '<pure_expr_stmt>', '<param_list_tail>', '<factor>', '<stmt_list>', '<rel_tail>', '<var_decl>', '<param>', '<function_list>']
terminals = ['EQ', 'GT', 'WHILE', 'SEMI', 'MULT', 'RBRACE', 'INT', 'COMMA', 'LPAREN', 'ELSE', 'DIV', 'LBRACE', 'IF', 'RPAREN', 'PLUS', 'MINUS', 'LE', 'ASSIGN', 'SET', 'IDENTIFIER', 'GE', 'VOID', 'RETURN', 'LT', 'NE', 'NUMBER']

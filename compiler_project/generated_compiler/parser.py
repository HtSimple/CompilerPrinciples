...
nonterminals = ['<return_tail>', '<if_tail>', '<factor>', '<var_decl>', '<param_list_tail>', '<function>', '<expr>', '<program>', '<param_list>', '<block_stmt>', '<add_tail>', '<type>', '<add_expr>', '<if_stmt>', '<mul_expr>', '<pure_expr_stmt>', '<assign_stmt>', '<while_stmt>', '<param>', '<return_stmt>', '<function_list>', '<stmt>', '<stmt_list>', '<mul_tail>', '<rel_tail>']
terminals = ['GE', 'RETURN', 'MINUS', 'LT', 'SET', 'PLUS', 'LPAREN', 'EQ', 'INT', 'IF', 'ASSIGN', 'LBRACE', 'IDENTIFIER', 'NUMBER', 'COMMA', 'WHILE', 'NE', 'LE', 'MULT', 'DIV', 'RBRACE', 'GT', 'VOID', 'RPAREN', 'SEMI', 'ELSE']
